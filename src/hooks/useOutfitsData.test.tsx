...
const mockUseOutfitsQuery = vi.mocked(staticDataHooks.useOutfitsQuery)
...
describe("useOutfits", () => {
  beforeEach(() => {
    ...
    // Set up default useOutfitsQuery mock
    mockUseOutfitsQuery.mockReturnValue({
      data: {},
      isLoading: false,
    } as any)
  })
